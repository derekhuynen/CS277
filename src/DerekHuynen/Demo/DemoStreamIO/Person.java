...
public class Person implements Serializable {
    ...
    /**
     * Copy constructor for the Person class.  This is a deep copy since it creates a whole new
     * object with new values for the member variables.
     * @param other		The Person to create a copy of.
     */
